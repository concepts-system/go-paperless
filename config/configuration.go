...
const (
	...
	keyProfiles          = "PAPERLESS_PROFILES"
	keyPublicURL         = "PAPERLESS_PUBLIC_URL"
	keyPort              = "PAPERLESS_PORT"
	keyDatabaseType      = "PAPERLESS_DB_TYPE"
	keyDatabaseURL       = "PAPERLESS_DB_URL"
	keyDatabaseMigrate   = "PAPERLESS_DB_MIGRATE"
	keyJWTAlgorithm      = "PAPERLESS_JWT_ALGORITHM"
	keyJWTKey            = "PAPERLESS_JWT_KEY"
	keyJWTExpirationTime = "PAPERLESS_JWT_EXPIRATION_TIME"
	keyJWTRefreshTime    = "PAPERLESS_JWT_REFRESH_TIME"
	keyDataPath          = "PAPERLESS_DATA_PATH"
